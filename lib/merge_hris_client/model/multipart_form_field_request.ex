...
defmodule MergeHRISClient.Model.MultipartFormFieldRequest do
  @moduledoc """
...
defimpl Poison.Decoder, for: MergeHRISClient.Model.MultipartFormFieldRequest do
  import MergeHRISClient.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"encoding", :struct, MergeHRISClient.Model.EncodingEnum, options)
  end
end
