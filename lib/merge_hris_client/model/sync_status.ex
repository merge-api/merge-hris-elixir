...
defmodule MergeHRISClient.Model.SyncStatus do
  @moduledoc """
...
defimpl Poison.Decoder, for: MergeHRISClient.Model.SyncStatus do
  import MergeHRISClient.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"status", :struct, MergeHRISClient.Model.SyncStatusStatusEnum, options)
  end
end
